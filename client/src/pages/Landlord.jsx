        ...
        <div className='flex flex-col p-2 text-gray-700 bg-gray-50 rounded mb-2 dark:bg-gray-900 dark:text-gray-400'>
          <div className='flex justify-between'>
            ...
            <div className='items-center flex w-[70%]} mx-2'>
              ...
              <div className='flex items-center cursor-pointer bg-gradient-to-r from-sky-500 via-teal-300 to-emerald-400 dark:text-gray-300 px-3 py-1 rounded text-[12px] text-white'>
