...
const Header = ({isDark, setDark}) => {
 ...
 ${isDark ? 'dark' : ''}`}>
        ...
        <div className='flex justify-around w-[30%] items-center py-2 px-4'>
           ...
           <Link to='/chatbot' className='group bg-gradient-to-r relative from-sky-500 via-teal-300 to-emerald-400 shadow-[inset_0_2px_4px_rgba(0,0,0,1)] rounded-full w-7 h-7 cursor-pointer'>
